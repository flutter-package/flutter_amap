...
class Amap {
  static const MethodChannel _channel =
      const MethodChannel('chavesgu/flutter_amap');
  ...
  static Future<void> setKey(
    ...
    await _channel.invokeMethod('setKey', Platform.isIOS ? iosKey : androidKey);
  }

  static Future<void> init(AMapLocationOption option) async {
    _channel.invokeMethod('init', option.toMap());
  }

  static Future<AMapLocation?> getLocation([bool needsAddress = true]) async {
    ...
    _channel.setMethodCallHandler((MethodCall call) async {
      switch (call.method) {
        case 'updateLocation':
          ...
          onLocationChange(AMapLocation.fromMap(argument));
      }
    });
